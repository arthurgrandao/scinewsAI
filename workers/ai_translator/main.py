...
from workers.ai_translator.src.ingest import ingest_paper
from workers.ai_translator.src.rag import query_rag
...
def main():
    ...
    if args.command == "file":
        ...
        try:
            from workers.ai_translator.src.db_processor import process_articles
